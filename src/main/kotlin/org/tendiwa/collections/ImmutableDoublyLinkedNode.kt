...
interface ImmutableDoublyLinkedNode<T> : Iterable<T> {
    /**
     * Content of a node.
     */
    val payload: T
     ...
     */
    val next: ImmutableDoublyLinkedNode<T>?
    /**
     * Previous node. [previous.next] is this node.
     */
    val previous: ImmutableDoublyLinkedNode<T>?
...
private class ForwardIterator<T>(
    start: ImmutableDoublyLinkedNode<T>
) : LinkedListIterator<T>(start) {
    override fun chooseNext(
        current: ImmutableDoublyLinkedNode<T>
...
private abstract class LinkedListIterator<T>(
    val start: ImmutableDoublyLinkedNode<T>
) : Iterator<T> {

    protected var current: ImmutableDoublyLinkedNode<T>? = start
